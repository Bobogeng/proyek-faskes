    ...
    <header class="flex flex-col items-center justify-center text-start md:text-center h-[568px] bg-gradient-to-bl from-[#005FED] to-[#4891FF] py-10 md:py-[100px] px-10 md:px-[72px] text-white">
        <div class="lg:w-2/3 mt-[68px]">
            <h1 class="text-3xl md:text-6xl pb-6 font-bold leading-normal">Apotik</h1>
            <p class="text-lg">Kami menyediakan banyak sekali daftar apotik yang berada di depok dengan berbagai macam review dan komentar dari berbagai macam pengunjung layanan kami.</p>
        </div>
    </header>
    <div class="bg-white py-10 md:py-[100px] px-10 md:px-[72px] border-b-2 border-b-[#D1D5DB]">
