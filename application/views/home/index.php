    ...
    <header class="flex flex-col items-center justify-center text-start md:text-center h-[568px] bg-gradient-to-bl from-[#005FED] to-[#4891FF] py-10 md:py-[100px] px-10 md:px-[72px] text-white">
        <div class="lg:w-2/3 mt-[68px]">
            ...
            <p class="text-lg">Fasilitas Kesehatan Depok merupakan layanan yang menyediakan tempat untuk mencari segala fasilitas kesehatan yang berada di Depok, kami menyediakan layanan yang sesuai dengan kebutuhan layanan kesehatan masyarakat.</p>
        </div>
    </header>
    <div class="grid lg:grid-rows-1 lg:grid-cols-2 gap-6 bg-white py-10 md:py-[100px] px-10 md:px-[72px]">
        <div>
            <h1 class="text-3xl pb-6 font-bold">Tentang Kami</h1>
            <p class="pb-6">Kami adalah penyedia layanan yang bersedia memberikan layanan berupa informasi mengenai fasilitas kesehatan yang berada di Depok. Kami menyediakan layanan tersebut berharap dapat membantu masyarakat dalam menemukan fasilitas kesehatan yang tepat di kota Depok.</p>
            <p>Kami juga memberikan kebebasan kepada pengguna untuk bisa memberikan review dan komentar kepada layanan yang telah kami sediakan, kami berharap kepada pengunjung layanan kami agar dapat tertarik dan yakin kepada fasilitas kesehatan yang mereka pilih. </p>
        </div>
        <div>
            <h1 class="text-3xl pb-6 font-bold">Team Kami</h1>
            <div class="grid grid-rows-4 grid-cols-1 md:grid-rows-2 md:grid-cols-2 gap-6">
                <div class="group flex items-center rounded-md border-2 border-[#005FED] p-5 transition ease-in-out hover:bg-[#005FED] hover:text-white hover:scale-[1.1]">
                    <img class="w-14 h-14 rounded-full mr-[10px]" src="https://i.pravatar.cc/300" alt="">
                    <div>
    ...
    <div class="flex flex-col items-center justify-center bg-gradient-to-bl from-[#005FED] to-[#4891FF] py-10 md:py-[100px] px-10 md:px-[72px] text-white">
